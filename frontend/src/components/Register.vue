...
const isFormValid = computed(() => {
    return email.value !== '' && 
        passwordValidation.value.isValid && passwordMatch.value
})
...
const handleLogin = (element: HTMLElement) => {
        ...
        <form @submit.prevent="handleRegister" class="space-y-4">
          ...
          <div class="tooltip">
            <input
              ...
              :class="[
                ...
                password.length > 0 ? (passwordValidation.isValid ? 'input-success border-green-500' : 'input-error border-red-500') : 'border-green-300'
              ]"
            />
          ...
          <div class="tooltip">
            <input
              ...
              :class="[
                'w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400',
                confirmPassword.length > 0 ? (passwordMatch ? 'input-success border-green-500' : 'input-error border-red-500') : 'border-green-300'
              ]"
            />
            <span class="tooltiptext">
              Veuillez retaper le même mot de passe pour confirmer
            </span>
          </div>
          ...
          <a @click="handleLogin" class="inline-block w-full text-end cursor-pointer text-green-600 hover:text-green-800">
            Se connecter
          </a>
